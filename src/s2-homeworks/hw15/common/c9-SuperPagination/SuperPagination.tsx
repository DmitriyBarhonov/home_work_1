...
//   onChange(page, itemsCountForPage); // Вызываем переданную функцию onChange с новой страницей и текущим количеством элементов на странице
// };

// const onChangeSelect = (event: React.ChangeEvent<HTMLSelectElement>) => {
//   const newCount = +event.target.value;
//   onChange(1, newCount); // Сбрасываем страницу на первую при изменении количества элементов на странице
// };
